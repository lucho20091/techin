              ...
              <div className="techin-header-wrap2">
                <div className="techin-header-main-menu menu2">
                                  ...
                                  if ('has_inner_dropdown' in sub_item) {
                                    return (
                                      <li key={sub_i} className={`${sub_item.has_inner_dropdown ? 'menu-item-has-children' : ''}`}>
                                        <Link to={sub_item.link || "#"} className={`${sub_item.has_inner_dropdown ? 'no-border' : ''}`}>{sub_item.title}</Link>
                  ...
                  <div className="header-btn header-btn-l1 d-none d-xs-inline-flex">
                    ...
                    <Link className="techin-default-btn techin-header-btn" to="/conact-u">Get A Quote</Link>
                  </div>
