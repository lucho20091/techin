...
const HeaderTwo = () => {
  ...
  return (
    <>
      <header
        className={`site-header techin-header-section techin-header-two ${sticky ? "sticky-menu" : ""}`}
        id="sticky-menu"
      >
                ...
                <div className="techin-header-info">
                  <ul>
                    <li>
                      <a href="tel:123">
                        <img
                          src="assets/images/blog/phone.svg"
                          alt="phone logo"
                        />{" "}
                        (+999) 123 98765
                      </a>
                    ...
                    <li>
                      <a href="mailto:name@email.com">
                        <img
                          src="assets/images/blog/gmail.svg"
                          alt="gmail logo"
                        />{" "}
                        info@techin.com
                      </a>
                                ...
                                {item.sub_menus?.map((sub_item, sub_i) => {
                                  if ("has_inner_dropdown" in sub_item) {
                                    return (
                                      <li
                                        key={sub_i}
                                        className={`${sub_item.has_inner_dropdown ? "menu-item-has-children" : ""}`}
                                      >
                                        <Link
                                          to={sub_item.link || "#"}
                                          className={`${sub_item.has_inner_dropdown ? "no-border" : ""}`}
                                        >
                                          {sub_item.title}
                                        </Link>
