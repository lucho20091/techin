...
const FooterOne = () => {
  return (
    <>
      <footer
        className="techin-footer-section1 section"
        style={{ backgroundImage: "url(/assets/images/v1/pricing-bg.png)" }}
      >
            ...
            <div className="row">
              <div className="col-xl-4 col-lg-12">
                <div className="techin-footer-textarea footer1">
                  ...
                  <p>
                    At Techin, we deliver innovative IT solutions to help
                    businesses thrive, offering customized strategies, robust
                    support, and cutting-edge technology for efficiency,
          ...
          <div className="techin-footer-bottom bottom2">
            <div className="techin-copywright">
              <p>
                ...
                <span className="footer-text">techin</span>.{" "}
                <a
                  href="https://www.sitequicker.com"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <span className="text-white">Website worked by </span>
                  <span className="footer-text"> Sitequicker.</span>
                </a>
              </p>
            </div>
