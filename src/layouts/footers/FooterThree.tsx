...
const FooterThree = () => {
  return (
    <>
      <footer
        className="techin-footer-section3 section"
        style={{ backgroundImage: "url(/assets/images/footer/footer-bg3.png)" }}
      >
          ...
          <div className="techin-footer-bottom bottom2">
            <div className="techin-copywright">
              <p>
                ...
                <span className="footer-text">techin</span>. All rights reserved
                by <span className="footer-text"> favdevs.</span>
              </p>
            </div>
