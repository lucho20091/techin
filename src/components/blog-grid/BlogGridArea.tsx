          ...
          <div className="row">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="blog-wrapper">
                ...
                <div className="blog-img">
                  <Link to="/about-us">
                    <img src="assets/images/blog/img3.png" alt="Blog Image" />
                    <div className="blog-date-wrap">
                      <div className="blog-year">
                        <span>2024</span>
                      </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="blog-wrapper">
                ...
                <div className="blog-img">
                  <Link to="/about-us">
                    <img src="assets/images/blog/img2.png" alt="Blog Image" />
                    <div className="blog-date-wrap">
                      <div className="blog-year">
                        <span>2024</span>
                      </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="blog-wrapper">
                ...
                <div className="blog-img">
                  <Link to="/about-us">
                    <img src="assets/images/blog/img4.png" alt="Blog Image" />
                    <div className="blog-date-wrap">
                      <div className="blog-year">
                        <span>2024</span>
                      </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="blog-wrapper">
                <div className="blog-content">
                  ...
                  <h5 className="blog-title">
                    <Link to="/about-us">
                      Managed IT Services vs. In-House IT: What’s Best for Your
                      Business?
                    </Link>
                  </h5>
                </div>
                <div className="blog-img">
                  <Link to="/about-us">
                    <img src="assets/images/blog/img5.png" alt="Blog Image" />
                    <div className="blog-date-wrap">
                      <div className="blog-year">
                        <span>2024</span>
                      </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="blog-wrapper">
                <div className="blog-content">
                  ...
                  <h5 className="blog-title">
                    <Link to="/about-us">
                      The Importance of Data Backup & Disaster Recovery in the
                      Digital Age
                    </Link>
                  </h5>
                </div>
                <div className="blog-img">
                  <Link to="/about-us">
                    <img src="assets/images/blog/img6.png" alt="Blog Image" />
                    <div className="blog-date-wrap">
                      <div className="blog-year">
                        <span>2024</span>
                      </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="blog-wrapper">
                ...
                <div className="blog-img">
                  <Link to="/about-us">
                    <img src="assets/images/blog/img7.png" alt="Blog Image" />
                    <div className="blog-date-wrap">
                      <div className="blog-year">
                        <span>2024</span>
                      </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="blog-wrapper">
                ...
                <div className="blog-img">
                  <Link to="/about-us">
                    <img src="assets/images/blog/img8.png" alt="Blog Image" />
                    <div className="blog-date-wrap">
                      <div className="blog-year">
                        <span>2024</span>
                      </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="blog-wrapper">
                ...
                <div className="blog-img">
                  <Link to="/about-us">
                    <img src="assets/images/blog/img20.png" alt="Blog Image" />
                    <div className="blog-date-wrap">
                      <div className="blog-year">
                        <span>2024</span>
                      </div>
